...
- 必须有：**19 个模型工具**（逐个列出签名与用途）、**56 条 HTTP 路由**、**115 个设置键**（8 组）、**6 处插槽注册**、数据文件清单、关键调用链（数字为 2026-09-25 代码实测；原记 17/49/85 为 2026-09-20 口径）
...
| 路 | 判据 |
|---|---|
| **4-A** | `FEATURE-INVENTORY.md` 三层齐全；**L3 覆盖 19 工具 / 56 路由 / 115 设置键 / 6 插槽，无「等等」省略** |
