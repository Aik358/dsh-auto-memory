...
import { checkPlanCriteriaPre } from '../../lib/wb-contract-pre.js'
...
ok(SRC.indexOf('那只是占位——你理解项目全貌后要用 memory_note_pre(kind=plan) 把它重写成真内容') !== -1,
  '每轮尾部提醒含「骨架只是占位，要重写成真内容」')
ok(SRC.indexOf('**首建亦可**') !== -1, 'memory_note_pre 工具描述含「首建亦可」')
