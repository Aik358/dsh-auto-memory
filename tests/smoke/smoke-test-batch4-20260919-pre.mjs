 ...
 *
 * #68：`semantic-decide-pre.js` 的 JS 实现自称「与 Python 对齐」但有三处分叉
 ...
 */
import { normalizeText, charWbNgramCounts } from '../../lib/semantic-decide-pre.js'
...
{
  const src = readFileSync(new URL('../../lib/semantic-decide-pre.js', import.meta.url), 'utf8')
