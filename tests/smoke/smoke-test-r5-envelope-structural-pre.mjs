 ...
 *   旧清洗器用一条**行首字面量白名单**识别信封，真机 `~/.dsh/memory/hub/procedures.json`
...
{
  ok(RUNTIME_ENVELOPE_V1 && typeof RUNTIME_ENVELOPE_V1.isEnvelopeLinePre === 'function',
    'RUNTIME_ENVELOPE_V1.isEnvelopeLinePre 可调用')
  ok(RUNTIME_ENVELOPE_V1.isEnvelopeLinePre('Approval prompts are disabled in this se') === true,
    '判据直接命中截断形态')
  ok(RUNTIME_ENVELOPE_V1.isEnvelopeLinePre('开始实施') === false,
    '判据不误伤真人原话')
}
