...
const A = await import(pathToFileURL(path.join(ROOT, 'lib', 'activation-inbox-pre.js')).href)
...
{
  const SRC = readFileSync(path.join(ROOT, 'lib', 'activation-inbox-pre.js'), 'utf8')
