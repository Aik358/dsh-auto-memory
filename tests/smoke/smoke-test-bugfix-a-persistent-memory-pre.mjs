...
// 这条是 facts.json 里真实出现过的漏网串（fact_9a706422e, 09-20 写入）
const REAL_DIRTY = [
...
ok(!/'candidate'/.test(PROC_CODE.match(/PROCEDURE_STAGES_V1 = Object\.freeze\(\[[^\]]*\]\)/)?.[0] || 'x'),
  'PROCEDURE_STAGES_V1 不再含 candidate')
