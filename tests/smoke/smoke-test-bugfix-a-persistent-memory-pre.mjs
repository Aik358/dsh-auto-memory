...
import { looksRuntimeResiduePre, stripRuntimeIntentPre } from '../../lib/intent-clean-safe-pre.js'
import { stripStatusLinePre } from '../../lib/note-status-pre.js'
...
const CLEAN = read('intent-clean-safe-pre.js')
const NOTE_STATUS = read('note-status-pre.js')
const FACT = read('fact-store-pre.js')
const EPISODIC = read('episodic-store-pre.js')
const PROC = read('procedure-store-pre.js')
