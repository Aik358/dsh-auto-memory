...
ok(SRC.includes("'auto-continue-state': '/api/dsh-auto-memory-pre/auto-continue-state'") && SRC.includes("'auto-continue-decide': '/api/dsh-auto-memory-pre/auto-continue-decide'"),
  'API 常量定义存在')
