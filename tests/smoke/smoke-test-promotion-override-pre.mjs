...
const HUB = readFileSync(path.join(ROOT, 'lib', 'memory-hub-pre.js'), 'utf8')
...
const G = PROCEDURE_DEFAULT_GATES_PRE_V1
...
{
  ok(/promotionOverrideView/.test(HUB), 'memory-hub-pre.js 引用 promotionOverrideView')
