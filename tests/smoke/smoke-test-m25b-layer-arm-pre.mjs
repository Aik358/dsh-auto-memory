 ...
 *
 * 背景（实测不一致，2026-09-18）：
 *   Tier-0 **注入**侧有层次优先级（tier-layer-inject-pre.js:58 TIER_LAYER_ORDER_PRE_V1
 *     = ['project','whiteboard','user','reflection','log'] + tier0-catalog-pre.js:419-455 的 caps/floors），
