...
import { selectCorrectionAttributionPre } from '../../lib/context-host.js'
import { createAccessEvidencePre, CORRECTION_LEXICON_V1 } from '../../lib/context-bridge.js'
...
console.log('[p9a] G7 接线源核验(emitTextEvidence 保留原产出 + 隐私)')
{
  ...
  ok(CORRECTION_LEXICON_V1.length > 0 && Object.isFrozen(CORRECTION_LEXICON_V1), '纠正词典非空且冻结(停止条件)')
}
