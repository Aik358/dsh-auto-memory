...
const GC = path.join(ROOT, 'lib', 'subagent-gc-pre.js')
...
ok(cl.includes(`currentVersion: cur }), try { localStorage.setItem('dsh-auto-memory-pre.seenVersion'`) ||
...
ok(cl.includes(`'data-dam-key': 'hubMechanicalProcedureFeedEnabled'`), 'V5c 设置页已补机械切片控件')
