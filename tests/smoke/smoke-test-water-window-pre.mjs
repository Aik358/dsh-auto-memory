 ...
 *
 * 守卫 lib/water-window-pre.js。实测故障:水位显示「500,998 / 131,072 token · 150%」——
...
import { parseModelWindowsPre, pickWindowPre, findOfficialContextWindowPre, findSessionModelPre, reusableWindowCachePre, shouldArmAutoContinuePre } from '../../lib/water-window-pre.js'
...
try {
  ...
  // 注:守卫的 import 路径按本仓 dev 车道写成 water-window-pre.js(主车道为 water-window.js)。
