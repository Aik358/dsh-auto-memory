...
import { rankFusionRRFPre, RECALL_FUSION_VERSION } from '../../lib/recall-fusion-pre.js'
...
t('T3-6 同一 observationId 二次 offer 被拒(duplicate-observation), 不产生第二个主激活', async () => {
  const { createActivationInboxPre } = await import('../../lib/activation-inbox-state-pre.js')
