...
import { extractL0Pre } from '../../lib/l0-extract.js'
import { probeJsSemanticAssets, createJsSemanticEnginePre } from '../../lib/semantic-js.js'
...
{
  const s = codeOnly(src('m7-index-sync-host.js'))
...
console.log('\n[④] 汇总：三条均不得回退（源码级反向锁）')
{
  const l0 = codeOnly(src('l0-extract.js')), sync = codeOnly(src('m7-index-sync-host.js')), sem = codeOnly(src('semantic-js.js'))
