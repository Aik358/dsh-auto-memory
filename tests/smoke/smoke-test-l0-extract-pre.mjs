/**
 * smoke-test-l0-extract-pre —— L0 抽取纯核心（l0_extract_pre_v1）回归锁定。
 * 纯 Node、零依赖、不联网；全部用例确定性（同输入同输出）。
 * 覆盖：锚点切分 / 三级 fallback / 时间戳剥离 / 短句并接 / 边界 / 确定性。
 */
import assert from 'node:assert/strict'
import { parseMemoryItemsPre, extractL0Pre, buildL0IndexPre, L0_EXTRACT_VERSION } from '../../lib/l0-extract-pre.js'
...
// ---------- 版本 ----------
t('version', () => assert.equal(L0_EXTRACT_VERSION, 'l0_extract_pre_v1'))
