...
import { isCurrentPre, L0_STATUSES } from '../../lib/l0-extract-pre.js'
...
{
  const mod = readFileSync(new URL('../../lib/tier-layer-inject-pre.js', import.meta.url), 'utf8')
...
{
  for (const p of ['../../lib/tier-layer-inject-pre.js', '../../lib/index.js', '../../lib/l0-extract-pre.js']) {
