...
if (registeredRoutes.length !== 43) throw new Error('expected 43 routes, got ' + registeredRoutes.length)
...
// ---------- E1 默认配置 ----------
{
  ...
  console.log('E1 默认配置 ✓ (memoryAnchorEnabled=false, 14 tools, 43 routes)')
}
