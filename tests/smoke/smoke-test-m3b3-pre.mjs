...
if (registeredRoutes.length !== 42) throw new Error('expected 42 routes, got ' + registeredRoutes.length)
...
// ---------- E1 默认配置 ----------
{
  ...
  console.log('E1 默认配置 ✓ (memoryAnchorEnabled=false, 14 tools, 42 routes)')
}
