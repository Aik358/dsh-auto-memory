...
if (registeredRoutes.length !== 35) throw new Error('expected 35 routes, got ' + registeredRoutes.length)
...
// ---------- E1 默认配置 ----------
{
  ...
  console.log('E1 默认配置 ✓ (memoryAnchorEnabled=false, 14 tools, 35 routes)')
}
