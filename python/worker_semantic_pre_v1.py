...
Extends the tested M7-0/M7-1 fake worker (python/worker_pre_v1.py) WITHOUT
...
import worker_pre_v1 as base  # noqa: E402  (tested M7-0/M7-1 protocol layer)
import m7_embedding_pre_v1 as emb  # noqa: E402
try:  # M7 activation feature v2 (round-1 shadow wiring)
    import m7_activation_features_pre_v2 as featv2  # noqa: E402
...
class SemanticWorker(base.Worker):
    ...
    def handle_frame(self, req):
        ...
        import sys as _sys
        try:
            # P13:recall_rank 在 base dispatch(worker_pre_v1.handle_frame)白名单外,在此拦截。
...
def run_loop(worker):
    """Byte-level twin of worker_pre_v1.main()'s stdin/stdout loop, bound to
