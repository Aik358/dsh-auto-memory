    ...
    function DialogHost() {
      ...
      if (dialogState.kind === 'welcomeTour' || dialogState.kind === 'modelDownload') {
        ...
        var TOUR_STEPS = [
          ...
          { core: '💉', kicker: locale === 'zh' ? '记忆快照' : 'SNAPSHOT',
          ...
          { core: '🔔', kicker: locale === 'zh' ? '日常体验' : 'EXPERIENCE',
          ...
          { core: '🔗', kicker: locale === 'zh' ? '外部记忆' : 'EXTERNAL',
          ...
          { core: '🔔', kicker: locale === 'zh' ? '唤起与固化' : 'ACTIVATION',
        ...
        return h('div', { 'data-dam-tour-backdrop': '',
          ...
          h('div', { 'data-dam-tour': '' },
            ...
            h('div', { 'data-dam-tour-body': '', key: 'body' + tourStep, 'data-dam-tour-swap': '' },
              ...
              step.externalScan ? h('div', { 'data-dam-tour-toggles': '' },
    ...
    function SettingsPage() {
      ...
      return h('div', { 'data-dam-settings': '' },
        ...
        section('appearance', sectionLabels.appearance, [
          ...
          // 不走 window 全局入口,避免多实例时序导致"点了没反应要刷新")
          field(t('fWelcomeTour'), h('div', { 'data-dam-row': '' },
            ...
            h('button', { 'data-dam-btn': '', onClick: function () { try { openDialog({ kind: 'welcomeTour' }) } catch (eTour) {} } }, t('tourReplay'))), t('fWelcomeTourHint')),
