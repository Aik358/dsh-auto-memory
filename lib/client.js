...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var API = {
      ...
      pyDetect: '/api/dsh-auto-memory/python-setup/detect',
      pyVenv: '/api/dsh-auto-memory/python-setup/venv',
      pyDeps: '/api/dsh-auto-memory/python-setup/deps',
      pyModel: '/api/dsh-auto-memory/python-setup/model',
      pyCancel: '/api/dsh-auto-memory/python-setup/cancel',
      pyStatus: '/api/dsh-auto-memory/python-setup/status',
      handoffState: '/api/dsh-auto-memory/handoff-state',
      handoffContinue: '/api/dsh-auto-memory/handoff-continue',
      handoffPermission: '/api/dsh-auto-memory/handoff-permission',
      autoContState: '/api/dsh-auto-memory/auto-continue-state',
      autoContDecide: '/api/dsh-auto-memory/auto-continue-decide',
