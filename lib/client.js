 ...
 */
console.log('[dsh-auto-memory] client v2.4.2 fingerprint: drawer-summary-ok')
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function saveConfigPatch(patch, hooks) {
      var h = hooks || {}
      var p = apiPost(API.config, patch)
