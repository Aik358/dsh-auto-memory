  ...
  factory: (require) => {
    ...
    var I18N = {
      zh: {
        ...
        memory: '记忆',
        autoMemory: '自动记忆',
        overview: '概览', logs: '日志', refineTab: '唤起回顾', notes: '笔记', reflections: '反思', connect: '接续', calendar: '日历', search: '检索', workspaces: '工作区', hubTab: '记忆中枢',
      ...
      en: {
        ...
        overview: 'Overview', logs: 'Logs', refineTab: 'Recall review', notes: 'Notes', reflections: 'Reflections', connect: 'Connect', calendar: 'Calendar', search: 'Search', workspaces: 'Workspaces', hubTab: 'Memory Hub',
    ...
    function MemoryPanel() {
      ...
      var tabs = [['overview', t('overview')], ['logs', t('logs')], ['refine', t('refineTab')], ['hub', t('hubTab')], ['notes', t('notes')], ['reflections', t('reflections')], ['connect', t('connect')], ['calendar', t('calendar')], ['search', t('search')], ['workspaces', t('workspaces')]]
      var style = {
        left: g.left + 'px',
        top: g.top + 'px',
        width: g.width + 'px',
