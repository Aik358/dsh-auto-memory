  ...
  factory: (require) => {
    ...
    var I18N = {
      zh: {
        ...
        waterCardTitle: '上下文水位', waterAutoSrc: '自动检测', waterManualSrc: '手动设定', waterThresholdHint: '水位达到 {t} 时注入交接建议并自动补写账本;窗口大小自动取自当前模型(settings.yaml contextWindow),也可在下方手动覆盖。',
      ...
      sumTitle: 'Period summary',
        ...
        waterCardTitle: 'Context water level', waterAutoSrc: 'auto-detected', waterManualSrc: 'manual', waterThresholdHint: 'Past {t} of the window, the handoff advisory is injected and the skeleton ledger is backfilled; the window auto-follows the active model (settings.yaml contextWindow) or your manual override below.',
