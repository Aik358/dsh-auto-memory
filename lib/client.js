...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CHANGELOG = {
      '0.1.31': { zh: [
        '修复:发布物运行时 section 名 `dsh:m6-reference-tail-pre` → 裸名(发布身份统一,不再带预览标识)。',
      ], en: [
        'Fix: release runtime section name `dsh:m6-reference-tail-pre` → bare name (unified release identity, no preview marker).',
      ] },
      '0.1.30': { zh: [
