  ...
  factory: (require) => {
    ...
    var I18N = {
      zh: {
        ...
        fWaterWindow: '水位估计窗口(字符)', fWaterWindowHint: '会话消息总字符达到该值即视为上下文将满(启发式);0=关闭水位感知。按所用模型窗口保守设定。',
      ...
      sumTitle: 'Period summary',
        ...
        fWaterWindow: 'Water-level window (chars)', fWaterWindowHint: 'When total session message chars reach this, context is considered nearly full (heuristic); 0 disables. Set conservatively per model window.',
    ...
    function SettingsPage() {
      ...
      return h('div', { 'data-dam-settings': '' },
        ...
        field(t('fWaterWindow'), h('input', { 'data-dam-input': '', type: 'number', min: 0, value: cfg.waterLevelWindowChars === undefined ? 240000 : cfg.waterLevelWindowChars, onChange: function (e) { set('waterLevelWindowChars', Number(e.target.value) || 0) } }), t('fWaterWindowHint')),
