 ...
 */
import { renderReferenceTail, computeExactDigest, REFERENCE_TAIL_BUDGET_V1, ACTIVATION_POLICY_VERSION } from './activation-inbox.js'
import { ActivationInboxRegistry, REFERENCE_TAIL_COOLDOWN_STEPS_V1 } from './activation-inbox-state.js'
...
export function createActivationHost(opts = {}) {
  ...
  function pushEvent(entry) {
    ...
    if (volatileEvents.length > VOLATILE_MAX_V1) {
  ...
  /** 最近写入的一份 miv(兼容投影:给既有诊断面板/老调用方用)。 */
  function latestMiv() {
    let last = null
