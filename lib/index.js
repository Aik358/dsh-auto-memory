...
import { createJsSemanticEnginePre, createSemanticDownloaderPre, fuseD6Pre, probeJsSemanticAssets, E5_SMALL_Q8_MANIFEST_PRE_V1 } from './semantic-js-pre.js'
...
export function apply(ctx, config) {
  ...
  // 只做检索排序,激活决策仍属两车道策略。下载器落位=发行包布局 lib/models。
  {
    ...
    engine.semanticAssetProbe = async () => probeJsSemanticAssets(pluginDir)
