 ...
 *
 * 管道:evidence-pre/events/*.jsonl(写入侧 context-bridge-pre,只读)→ 有界扫描 →
...
export const EVIDENCE_AGG_VERSION = 'evidence_agg_pre_v1'

/** 有界读取默认值。 */
export const EVIDENCE_AGG_DEFAULTS_PRE_V1 = Object.freeze({
...
export function scanEvidenceEventsPre(io, opts = {}) {
  const d = Object.assign({}, EVIDENCE_AGG_DEFAULTS_PRE_V1, opts)
