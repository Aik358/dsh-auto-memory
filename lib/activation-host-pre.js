...
import { resolveDshHomeForEnginePre } from './dsh-home-pre.js'
import { buildSourceCatalog, loadCorpusSnapshot, CorpusRegistry, canonicalize } from './m4-corpus-pre.js'
import { resolveProcedureInjectEnabledPre } from './procedure-switch-pre.js'
...
export function createActivationHost(opts = {}) {
   ...
   * 这里补齐投影字段,判定与 fail-closed 语义在 `lib/tier-layer-inject-pre.js:selectReusableTierHitsPre`。
  ...
  function matchSkillByCandidates(req) {
    try {
      ...
      // 实际控制的是「主动唤起」这条臂是否开启），统一交给接口契约模块 lib/procedure-switch-pre.js
