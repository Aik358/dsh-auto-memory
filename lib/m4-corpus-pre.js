...
import { parseSidecar } from './memory-anchor-pre.js'
import { memoryIndexVersion as computeIndexVersion, SHADOW_LEXICAL_BUDGET_PRE_V1 as BUDGET } from './shadow-retrieval-pre.js'
...
export function loadCorpusSnapshot(catalog, io = {}, opts = {}) {
  ...
  for (const source of catalog.sources) {
    ...
    //   （契约见 `memory-anchor-pre.js` 的 `parseAnchors` 与其 C18 断言；`fileDigest` 则按含 BOM 的整 buffer 算）。
