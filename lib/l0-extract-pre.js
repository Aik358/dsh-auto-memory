...
function isDegenerateHeading(title) {
  ...
  // 把正文里的隐私标记当成了 L0（`smoke-test-l0-index-pre.mjs` 的"索引不得含原文"断言真红）。
 ...
 *
 * 与 `recall-fusion-pre.js:FUSION_LAYER_ORDER_PRE_V1` / `tier-layer-inject-pre.js:TIER_LAYER_ORDER_PRE_V1`
 ...
 * ⇒ **两处判据不同是有意为之**，不是漏改（`tier-layer-inject-pre.js` 继续 import `isCurrentPre`）。
 *
 * @param {{status?:string}|null|undefined} record 记录（或任何带 status 的对象）
