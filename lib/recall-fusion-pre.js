 ...
 * ★M2.5b：层次优先级序（与注入侧一致）。
 *
 * 出处：`tier-layer-inject-pre.js:58 TIER_LAYER_ORDER_PRE_V1` —— **必须与之逐字相同**。
 *
...
export function rankFusionRRFPre(pairs, opts = {}) {
   ...
   * 出处：`tier-layer-inject-pre.js:58 TIER_LAYER_ORDER_PRE_V1`
  ...
  //   （tier-layer-inject-pre.js:58 TIER_LAYER_ORDER_PRE_V1 = ['project','whiteboard','user','reflection','log']
  //    + tier0-catalog-pre.js:419-455 的 caps/floors），而 **排序**侧对层次完全无感
