/**
 * board-mode-pre —— WB-GRAPH 白板线总开关(2026-09-16, board_mode_v1)。
 *
 ...
 *  - graph_* 工具(dsh-graph vendor)与 memory_expand/memory_trace(P3)
 *    仅在 boardMode='graph' 时注册; P2 sidecar 仅在 'graph' 时写盘。
 *  - fail closed: 非法值一律按 legacy(旧行为), 绝不猜。
 */

export const BOARD_MODE_VERSION = 'board_mode_v1'
export const BOARD_MODES_V1 = Object.freeze(['legacy', 'graph'])
