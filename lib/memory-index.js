 ...
 * @param {{sourceVersion?:number,fileDigest?:string}} prev 上次构建信息(用于版本递增;与宿主缓存
 *        index.js _memoryIndexState 的键名一致 —— ★2026-09-19 修复（issue #92）：旧实现读 prev.version
 *        而宿主只写 sourceVersion,版本门在生产路径恒读 undefined ⇒ 版本封顶 2、未变重读回退 1)
