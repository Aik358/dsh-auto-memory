...
import { loadAndVerifyPolicy, decideActivationV2 } from './lib/semantic-decide-pre.js'

let pass = 0, fail = 0
const ok = (c, n) => { if (c) { pass++; console.log('  ok - ' + n) } else { fail++; console.error('  FAIL - ' + n) } }
const INTENT = 'D:/dsh-auto-memory/python/policies/recall_intent_lr_pre_v1.json'
const POLICY = 'D:/dsh-auto-memory/python/policies/activation_policy_pre_v2.json'
